classdef (StrictDefaults) CostasAmSignalPLL < matlab.System
    ...
    methods
        % Constructor
        function obj = CostasAmSignalPLL(varargin)
    ...
    methods(Access = protected)
        ...
        function setupImpl(obj)
            ...
            obj.InphaseFIR = dsp.FIRFilter(H.Numerator);
            obj.QuadratureFIR = dsp.FIRFilter(H.Numerator);
        end
